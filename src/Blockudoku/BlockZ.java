...
public class BlockZ extends Block {
    ...
    protected void fillBlock() {
        Rectangle rec1 = new Rectangle(40, 40, Color.TURQUOISE);
        rec1.setStroke(Color.BLACK);
        rec1.setStrokeWidth(2);
        Rectangle rec2 = new Rectangle(40, 40, Color.TURQUOISE);
        rec2.setStroke(Color.BLACK);
        rec2.setStrokeWidth(2);
        Rectangle rec3 = new Rectangle(40, 40, Color.TURQUOISE);
        rec3.setStroke(Color.BLACK);
        rec3.setStrokeWidth(2);
        Rectangle rec4 = new Rectangle(40, 40, Color.TURQUOISE);
        ...
        if(getRotation() == 0 || getRotation() == 180) {
            ...
            coord[1][1] = '#'; gridPane.add(rec3, 1, 1);
            coord[2][0] = '#'; gridPane.add(rec4, 0, 2);
        }
    }
}
