...
public class BlockJ extends Block {
    ...
    protected void fillBlock() {
        Rectangle rec1 = new Rectangle(40, 40, Color.FUCHSIA);
        rec1.setStroke(Color.BLACK);
        rec1.setStrokeWidth(2);
        Rectangle rec2 = new Rectangle(40, 40, Color.FUCHSIA);
        rec2.setStroke(Color.BLACK);
        rec2.setStrokeWidth(2);
        Rectangle rec3 = new Rectangle(40, 40, Color.FUCHSIA);
        rec3.setStroke(Color.BLACK);
        rec3.setStrokeWidth(2);
        Rectangle rec4 = new Rectangle(40, 40, Color.FUCHSIA);
